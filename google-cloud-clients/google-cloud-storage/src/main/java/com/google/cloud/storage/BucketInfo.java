...
public class BucketInfo implements Serializable {
   ...
   * which defines one of two states. When {@code BucketField.VERSIONS} is used explicitly to request this field
   * the return value {@code null} is equivalent to {@code false}. On the other hand if the field is not explicitly used
   * then {@code null} represents the value is not available.
   */
   ...
   *
   * <p>Returns the effective time of a retention policy this bucket. Returns {@code long} if
   * re for this bucket or {@code null}.
   *
   * <p>When {@code BucketField.DEFAULT_EVENT_BASED_HOLD} is used explicitly to request this field
   * the return value {@code null} is equivalent to {@code false}. On the other hand if the field
   * is not explicitly used then {@code null} represents the value is not available.
   */
